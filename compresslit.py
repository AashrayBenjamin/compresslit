...
def main():
    ...
    st.markdown("<div><h1 style='text-align: center;'>CompressLit </h1> <h2>Image Compression</h2></div>", unsafe_allow_html=True)
    ...
    if img_file_buffer is not None:
        ...
        with col2:
            ...
            final_siz = getsizeof(compressed_bytes.get(preferred_k))
            st.write(f'Compressed size: {final_siz / 1000} kilobytes.')
